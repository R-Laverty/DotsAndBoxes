    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (mGame.isFinished){
            if (player1Score>player2Score){
                canvas.drawText("Player 1 wins with a score of: $player1Score",0f,height-height/6.toFloat(), player1TextPaint)
            }else{
                canvas.drawText("Player 2 wins with a score of: $player2Score", 0f, (height+70)-height/6.toFloat(), player2TextPaint)
            }
        }else{
            //Draw player scores
            canvas.drawText("Player 1 Score: $player1Score",width/4.toFloat(),height-height/6.toFloat(), player1TextPaint)
            canvas.drawText("Player 2 Score: $player2Score", width/4.toFloat(), (height+70)-height/6.toFloat(), player2TextPaint)
        }
        ...
        for(line in mGame.lines){
            ...
            if (line.lineY%2==0){
                ...
                lineTop = lineThickness*((line.lineY+1)/2) + chosenLineWidth*(((line.lineY+1)/2)-1)
